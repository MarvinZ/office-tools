...
export default function AddAssetModal() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // redirect happens server-side, so we won't reach here on success
    setPending(false);
  }
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/50 px-4 py-10">
          <div className="w-full max-w-xl rounded-2xl bg-white shadow-2xl dark:bg-zinc-950">
            ...
            {/* Form */}
            <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-5 px-6 py-5">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <Field label="Assigned to" name="assignedTo" placeholder="John Doe" />
